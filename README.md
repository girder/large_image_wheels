...
```
docker run --rm -p 8888:8888 jupyter/minimal-notebook bash -c 'pip install git+git://github.com/girder/large_image.git#egg=large_image[openslide,mapnik] -f https://manthey.github.io/large_image_wheels && start.sh jupyter notebook --NotebookApp.token="" --ip=0.0.0.0'
```
